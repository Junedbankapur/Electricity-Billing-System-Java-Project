...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup() {
        ...
        // Fetch customer name when meter number loses focus
        ...
        JLabel boyLabel = new JLabel(new ImageIcon(boyImg));
        ...
        if (e.getSource() == create) {
            ...
            try {
                ...
                if (sloginAs.equals("Admin")) {
                    ...
                    // If name is not filled, fetch it
                    if (sname.isEmpty()) {
                        ResultSet rs = c.statement.executeQuery("SELECT name FROM signup WHERE meter_no = '" + smeter + "'");
                        if (rs.next()) {
